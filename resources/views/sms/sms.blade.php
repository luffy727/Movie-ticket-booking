                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                         ...
                         <div class="form-group">
                              ...
                              <input type="number" name="phone" class="form-control input-rounded" placeholder="input-rounded">
                         </div>
                         <div class="form-group">
                              <label for="Messege"></label>
                              <textarea class="form-control" name="messege" rows="4" id="comment"></textarea>
                         </div>
