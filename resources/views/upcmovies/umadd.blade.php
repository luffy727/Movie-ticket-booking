        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add UpComing Movie</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{ url('upmovie-insert') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <ul  class="form-group" id="saveform_errlist"> </ul>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label style="color:black;">Film Name</label>
                                <input type="text" class="form-control mname" name="umname" >
                                <span id="mname_error" style="color:red;"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label style="color:black;">Film Type</label>
                                <select class="form-select mtype" name="umtype" aria-label="Default select example">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="sdescription" class="form-control mdescription" rows="3" id="comment"></textarea>
                                <span id="mdescription_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Release Date</label>
                                <input type="date" name="rdate" id="" class="form-control date">
                                <span id="date_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Trailer URL</label>
                                <input type="text" name="trailer" class="form-control video_url" id="">
