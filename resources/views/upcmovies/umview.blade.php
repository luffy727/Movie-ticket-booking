    ...
    <div class="modal fade" id="deleteModel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('updelete') }}" method="POST">
                @csrf
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="upmovie_delete_id" id="upm_id">
                                ...
                                <table class="table table-dark table-striped" id="myTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-white">Movie type</th>
                                            <th class="text-white">Movie descriptiob</th>
                                    ...
                                    <tbody>
                                        @foreach ($upmovie as $item)
                                        <tr>
                                            <td class="text-white"><b>{{ $item->id}}</b></td>
                                            <td class="text-white"><b>{{ $item->umname}}</b></td>
                                            <td class="text-white"><b>{{ $item->umtype }}</b></td>
                                            <td class="text-white"><b>{{ $item->sdescription }}</b></td>
                                            <td class="text-white">{{ $item->rdate }}</td>
                                            <!-- <td>
                                                <a href="{{ url('edit-prod/'.$item->id) }}" class="btn btn-info">Edit</a>
                                            </td> -->
                                            <td>
                                            <button type="button" class="btn btn-danger deleteUpBtn" value="{{ $item->id }}">Delete</button>
