            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{ url('insert-movie') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <ul  class="form-group" id="saveform_errlist"> </ul>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label style="color:black;">Film Name</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-select mtype" name="mtype" aria-label="Default select example">
                            ...
                            <div class="form-group col-md-12">
                                <label style="color:black;">Film Description</label>
                                <textarea name="mdescription" class="form-control mdescription" rows="4" id="comment"></textarea>
                                <span id="mdescription_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Hall</label>
                                <input type="text" name="hall" class="form-control hall" id="">
                                <span id="hall_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Ticket price for Children</label>
                                <input type="number" name="chticket_price" class="form-control chticket_price">
                                <span id="chticket_price_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Ticket Price for Adult</label>
                                <input type="number" name="adticket_price" class="form-control adticket_price">
                                <span id="adticket_price_error" class="text-red"></span>


                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Seats</label>
                                <input type="number" name="seat_qty" class="form-control seat_qty">
                                <span id="seat_qty_error" class="text-red"></span>


                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Premeire Date</label>
                                <input type="date" name="date" id="" class="form-control date" >
                                <span id="date_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Premeire Time</label>
                                <input type="time" name="time" id="" class="form-control time">
                                <span id="time_error" class="text-red"></span>

                            </div>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label" style="color:black;">
                                    <input type="checkbox" name="trending" class="form-check-input trending" value="1">Trending
                                </label>
                                <span id="trending_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Trailer URL</label>
                                <input type="text" name="video_url" class="form-control video_url" id="">
                                <span id="hall_error" class="text-red"></span>

                            </div>
                            <div class="form-group col-md-12">
                                <input type="file" name="image" class="form-control image">
                                <span id="image_error" class="text-red"></span>
