                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-select" name="mtype" aria-label="Default select example">
                                   <option value="">{{ $movie->mtype }}</option>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="mdescription" class="form-control" rows="4" id="comment" >{{ $movie->mdescription }}</textarea>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Hall</label>
                                <input type="text" name="hall" class="form-control" id="" value="{{ $movie->hall }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Ticket price for Children</label>
                                <input type="number" name="chticket_price" class="form-control" value="{{ $movie->chticket_price }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Ticket Price for Adult</label>
                                <input type="number" name="adticket_price" class="form-control" value="{{ $movie->adticket_price }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Seats</label>
                                <input type="number" name="seat_qty" class="form-control" value="{{ $movie->seat_qty }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Premeire Date</label>
                                <input type="date" name="date" id="" class="form-control" value="{{ $movie->date }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" style="color:black;">Premeire Time</label>
                                <input type="time" name="time" id="" class="form-control" value="{{ $movie->time }}">
                            </div>
                            ...
                            @if($movie->image)
                              <img src="{{ asset('uploads/movie/'.$movie->image) }}" alt="" style="width:200px;">
                            @endif
                            <div class="form-group col-md-12">
                                <input type="file" name="image" class="form-control">
                            </div>
                        </div>
                            <button type="submit" class="btn btn-outline-primary" id="submitForm">Update</button>
                            <script>
