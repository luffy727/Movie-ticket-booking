                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa-solid fa-film text-primary border-primary"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                                    <div class="stat-text">Total Movies</div>
                                    <div class="stat-digit">{{$movie}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa-solid fa-cart-shopping text-pink border-pink"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa-solid fa-list text-danger border-danger"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                                    <div class="stat-text">Total Category</div>
                                    <div class="stat-digit">{{$catagory}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                ...
                                <div class="stat-content d-inline-block">
                                    ...
                                    <div class="stat-digit">{{ $booking }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100 " src="{{ asset('image/Home.jpg') }}" alt="First slide">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Join with us</h5>
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('image/Filmzo 2.jpg') }}" alt="Second slide">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Best ticket booking site</h5>
                                                    
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('image/Filmzo 3.jpg') }}" alt="Third slide">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Also Mobile reponsive</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
