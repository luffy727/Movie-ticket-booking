            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            ...
                            <!-- <li><a href="{{ route('sms') }}">Send Promotion SMS</a></li> -->
    ...
    <div class="modal fade" id="deleteModel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('delete-prod') }}" method="POST">
                @csrf
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('products') }}" type="button" class="btn btn-secondary" data-dismiss="modal">Close</a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('ep-product-pdf') }}" class="btn btn-outline-primary">Export PDF</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display table student-data-table m-t-20 " id="">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-black">Selling Price</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black"><b>{{ $item->name}}</b></td>
                                            <td class="text-black"><b>{{ $item->description }}</b></td>
                                            <td>
                                                <img src="{{ asset('uploads/product/'.$item->image) }}" alt="Image here" style="width:100px;">
                                            </td>
                                            <td class="text-black"><b>{{ $item->selling_price }}</b></td>
                                            <td>
                                                <a href="{{ url('edit-prod/'.$item->id) }}" class="btn btn-info">Edit</a>
                                            </td>
                                            <td>
                                            <button type="button" class="btn btn-danger deleteProdBtn" value="{{ $item->id }}">Delete</button>
