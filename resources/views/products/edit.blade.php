            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="{{ route('addcatagory') }}">Chartjs</a></li>
                        <li><a href="{{ route('addproduct') }}">Add Merchandise</a></li>
                        <li><a href="./chart-chartjs.html">Chartjs</a></li>
                        <li><a href="./chart-morris.html">View Merchandise</a></li>
                        <li><a href="./chart-chartjs.html">Chartjs</a></li>
                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="small_description" class="form-control" rows="2" id="comment">{{ $product->small_description }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label style="color:black;">Description</label>
                                <textarea name="description" class="form-control" rows="4" id="comment">{{ $product->description }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label" style="color:black;">
                                    <input type="checkbox" name="status" class="form-check-input" value="" >Status
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label" style="color:black;">
                                    <input type="checkbox" name="trending" class="form-check-input" value="">Trending
                                </label>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="meta_decription" class="form-control" rows="3">{{ $product->meta_decription }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
